...
try:
    sp = pd.read_csv('C:/Users/XPS/Desktop/Streamlit App/database/Student Attitude and Behavior.csv')
except UnicodeDecodeError:
    sp = pd.read_csv('C:/Users/XPS/Desktop/Streamlit App/database/Student Attitude and Behavior.csv', encoding='ISO-8859-1')
